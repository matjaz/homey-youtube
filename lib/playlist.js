...
function onFlowActionStopPlayList (callback, args) {
  var playlistTimeout = cachedPlaylist && cachedPlaylist.nextTimeout
  if (playlistTimeout) {
    clearTimeout(playlistTimeout)
    cachedPlaylist.nextTimeout = null
  }
  callback(null, !!playlistTimeout)
}
